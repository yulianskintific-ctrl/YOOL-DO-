      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-slate-100">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <span className="px-2.5 py-0.5 rounded-full text-[9px] font-black tracking-widest text-blue-800 bg-blue-100 uppercase">
              Modular Module
            </span>
            {isFallbackActive && (
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-xl text-[10px] font-bold uppercase tracking-widest bg-slate-50 hover:bg-slate-100 text-slate-600 border border-slate-200 shadow-sm transition-all"
          >
            <Code size={14} />
            Setup Database
          </button>
